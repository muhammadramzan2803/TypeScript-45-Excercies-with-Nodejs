...
var transportataionModes = ["Sports Bike", "Bus", "Car", "Sports Car"];
transportataionModes.forEach(function (mode) { return console.log("I would like to own a ".concat(mode)); });
